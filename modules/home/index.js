        ...
        break;
                          default:
                               ...
                               BFSubjects.search({typeSid:'butachimie-person', rules: [
                                ...
                                InstallationsService.search({subjectId: tag,relType:'is-installed-at',timestamp:today}).then(function(installations){//relType: 11,timestamp:today,subjectId: tag
                                    if(installations!=0){
                                    var inst=installations[0];
                                    inst.endVt=(new Date()).toISOString();
                                    InstallationsService.persist(inst).then(function resolve(){
