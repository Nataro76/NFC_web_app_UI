define([ 'require','libbf'], function ( require, libbf ) {
    ...
    return angular.module("app.home", [ 'ui.router' ])
      ...
      .controller('homeCtrl', [ "$scope", "$element", 'BFUserPrefsService','BFAuthService','InstallationsService','BFSubjectsService','$q', function ( $scope, $element, userPrefs,BFauth, InstallationsService,BFSubjects,q) {
